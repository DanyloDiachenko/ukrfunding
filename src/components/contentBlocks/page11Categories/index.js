			...
			<div className='d-flex justify-content-center mb-5'>
				<div className='categories__input'>
					...
					<button className='categories__input__btn'>
						<img src='/image/header_bottom_search_moded.svg' alt="search" />
					</button>
				</div>
			</div>
			<div className="row categories-row d-flex justify-content-center">
				<div className="col-xxl-3 col-xl-4 col-lg-6 col-md-12 mt-4 p-0">
					<div className="categories__item">
						<img src="/image/page11_categories_glasses.svg" className="categories__item__icon" alt="icon" />
				...
				<div className="col-xxl-3 col-xl-4 col-lg-6 col-md-12 mt-4 p-0">
					<div className="categories__item">
						<img src="/image/page11_categories_book.svg" className="categories__item__icon" alt="icon" />
				...
				<div className="col-xxl-3 col-xl-4 col-lg-6 col-md-12 mt-4 p-0">
					<div className="categories__item">
						<img src="/image/page11_categories_camera.svg" className="categories__item__icon" alt="icon" />
